        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">
                    <?php echo lang('manage_invoice'); ?>
                    <?php if(in_array('createProduct', $user_permission)): ?>
                      <a href="<?php echo base_url('Controller_Invoice/create') ?>" style="padding:0 5px !important;" class="btn btn-primary">Add <?php echo lang('invoice'); ?></a>
...
<?php if(in_array('deleteInvoice', $user_permission)): ?>
<!-- remove brand modal -->
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal" data-backdrop="static">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"><?php echo lang('remove_invoice'); ?></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>

      <form role="form" action="<?php echo base_url('Controller_Invoice/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    dom: 'Bfrtip',
    'ajax': base_url + 'Controller_Invoice/fetchOrdersData',
    'order': []
  });
