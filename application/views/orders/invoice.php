              ...
              <div class="box-body">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="hidden" name="customer" id="customer" value="<?php echo $order_data['order']['customer_id'] ?>">

                      <select class="form-control select_group customer" disabled onchange="getCustomerDetails(this.value)" id="customer_id" name="customer_id" required>
                            <option value=""></option>
