  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('Controller_Members/') ?>"><?php echo lang('members'); ?></a></li>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <h1><?php echo lang('do_you_really_want_to_remove'); ?> ?</h1>
          ...
          <form action="<?php echo base_url('Controller_Members/delete/'.$id) ?>" method="post">
            ...
            <a href="<?php echo base_url('Controller_Members') ?>" class="btn btn-warning"><?php echo lang('cancel'); ?></a>
          </form>
