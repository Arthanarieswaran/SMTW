...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">  <?php echo lang('items'); ?></li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBrand', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">Add Item<?php echo lang(''); ?></button>
          <br /> <br />
        <?php endif; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo lang('add_item'); ?></h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('Controller_Items/create') ?>" method="post" id="createBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name"> <?php echo lang('item_name'); ?></label>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('Controller_Items/update') ?>" method="post" id="updateBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name"><?php echo lang('item_name'); ?></label>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeBrandModal">
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo lang('remove_item'); ?></h4>
      </div>

      <form role="form" action="<?php echo base_url('Controller_Items/remove') ?>" method="post" id="removeBrandForm">
        <div class="modal-body">
          <p><?php echo lang('do_you_really_want_to_delete'); ?>?</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo lang('close'); ?></button>
